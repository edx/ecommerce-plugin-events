...
"""
events documentation build configuration file.
...
project_title = 'ecommerce events'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Plugin to handle ecommerce events',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'events'),
                os.path.join(root_path, 'events/migrations')])
